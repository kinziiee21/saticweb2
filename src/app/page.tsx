            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 mb-8">
              ...
              <div className="w-full lg:w-[48%] flex justify-center lg:pt-8">
                <Image
                  ...
                  width={400}
                  height={400}
                  className="w-full h-auto max-w-[340px] md:max-w-[380px] lg:max-w-[400px] rounded-[1.75rem] border border-brand-border shadow-lg"
      ...
      <section id="focus-areas" className="px-6 py-10 md:py-12 bg-[#FAF9F6]/40 border-b border-brand-border">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-6xl w-full mx-auto mt-12 bg-brand-primary/[0.04] border border-brand-primary/10 rounded-2xl p-5 md:p-6 text-center shadow-xs">
            <p className="text-lg md:text-xl lg:text-2xl font-extrabold text-brand-primary leading-relaxed font-display">
